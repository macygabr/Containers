...
//   list(size_type n);  // parameterized constructor, creates the list of size
//   n list(std::initializer_list<value_type> const
...
//   iterator insert(
//       iterator pos,
//       const_reference value);  // inserts element into concrete pos and
//       returns
//                                // the iterator that points to the new element
//   void erase(iterator pos);    // erases element at pos
//   void push_back(const_reference value);   //	adds an element to the
//   end void pop_back();                         // removes the last element
//   void push_front(const_reference value);  //	adds an element to the
//   head void pop_front();                        //	removes the first
//   element void swap(list &other);                  // swaps the contents void
//   merge(list &other);                 // merges two sorted lists void splice(
//       const_iterator pos,
