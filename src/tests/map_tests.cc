...
TEST(TestGroupName, Iterators1_int) {
  ...
  // it1++;
  // it1++;
  // std::cout << it1.node->node_key << std::endl;
...
//   // it1++;
//   // std::cout<<it1.node->node_val<<std::endl;
//   // it2++;
//   // std::cout<<it2->second<<std::endl;

//   //  for (; it1 != a.end() || it2 != b.end(); it1++,it2++) ;
//   // std::cout <<"Ключ " << it1->first << ", значение " << it1->second<<
//   // std::endl; a.printTree(a.root);
// }

// TEST(TestGroupName, set) {
