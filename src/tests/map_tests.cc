...
//   for (int i = 0; i < 50; i++) {
//     std::pair<std::string, int> x = {std::to_string(rand() % 100), rand() %
//     100}; ASSERT_EQ(a.insert(x).second, b.insert(x).second);
//   }
//   a["Nurlan"] = 333;
//   b["Nurlan"] = 333;
...
//   for (int i = 0; i < 50; i++) {
//     std::pair<std::string, char> x = {std::to_string(rand() % 100), rand() %
//     100}; ASSERT_EQ(a.insert(x).second, b.insert(x).second);
//   }
//   a["Nurlan"] = 'O';
//   b["Nurlan"] = 'O';
...
TEST(TestGroupName, Merge) {
  ...
  // int i=0;
  // for(it1 = a2.begin(); i<10; i++) it1++;
  // i=0;
  // for (; i<20; i++) it1 = a2.erase(it1);
